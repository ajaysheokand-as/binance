...
export default function AuthenticatorVerification() {
  ...
  return (
    <div className="flex flex-col h-screen color text-white">
      ...
      <div className="flex-1 flex flex-col p-6">
        ...
        <div className="mt-2">
          <label className="block text-gray-400 mb-2">Authenticator App</label>
  ...
  >
        <button 
          ...
          disabled={code.length !== 6 || isLoading}
          className={`w-full py-4 mt-6 rounded-lg font-medium bg-yellow-400 fromValue ${
        ...
        <div className="mt-6 space-y-4">
          <button className="w-full text-left text-yellow-400">
      ...
      <div className="p-6 flex justify-center items-center">
        ...
        <span className="text-gray-400">Protected by Binance Risk</span>
      </div>
    </div>
  );
}